...
Here, we implement the basic KMP algorithm. Given a short pattern and a long text, both strings, determine whether the
...
print computeShifts("abababca")
print computeShifts("aabaabaaa")