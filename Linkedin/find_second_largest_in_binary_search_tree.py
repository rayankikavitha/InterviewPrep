#find_second_largest_in_binary_search_tree.py

# largest is right most child
# second largest is - parent of largest, if the right most child left substree is Missing, else
#.   largest in the left sub tree
